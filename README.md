...
## 📚 Study Reference
The code and concepts applied here are based on the study of **"Java: The Complete Reference"** by Herbert Schildt.
...
Java, on the other hand, was created in 1991 by Sun Microsystems, Inc. with the intention of fulfilling another apparent need: platform independence.
...
A Java program that calculates the day of the week for any given date using Zeller's Congruence formula.
